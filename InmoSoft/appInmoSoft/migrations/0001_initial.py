...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('apaNumeroTorre', models.IntegerField(db_comment='Numero de Torre', max_length=20)),
                ('apaNumeroInmueble', models.IntegerField(db_comment='Numero de inmueble', max_length=20)),
                ('apaTotalApartamento', models.IntegerField(db_comment='Total de apartamentos en el proyecto', max_length=20)),
                ...
                ('apaPrecioVivienda', models.IntegerField(db_comment='Precio de vivienda', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('casNumeroManzana', models.IntegerField(db_comment='Numero de manzana', max_length=20)),
                ('casNumeroInmueble', models.IntegerField(db_comment='Numero de inmueble', max_length=20)),
                ('casTotalCasas', models.IntegerField(db_comment='Total de casas en el proyecto', max_length=20)),
                ('casCategoria', models.CharField(choices=[('Tipo A', 'Tipo A'), ('Tipo B', 'Tipo B'), ('Tipo C', 'Tipo C')], db_comment='Tipo de casa', max_length=15)),
                ('casPrecioVivienda', models.IntegerField(db_comment='Precio de vivienda', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cliNombre', models.CharField(db_comment='Nombre del cliente', max_length=20)),
                ('cliApellido', models.CharField(db_comment='Apellido del cliente', max_length=20)),
                ('cliTelefono', models.CharField(db_comment='Telefono del cliente', max_length=20)),
                ('cliCorreo', models.CharField(db_comment='Correo del cliente', max_length=20)),
                ('cliCedula', models.CharField(db_comment='cedula del cliente', max_length=20)),
                ('cliDireccion', models.CharField(db_comment='Direccion del cliente', max_length=20)),
                ('cliEstadoCivil', models.CharField(choices=[('Soltero', 'Soltero'), ('Casado', 'Casado')], db_comment='Estado Civil del cliente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inmNumeroHabitaciones', models.IntegerField(db_comment='Numero de habitaciones de un inmueble', max_length=20)),
                ('inmAreaConstruida', models.CharField(db_comment='Area construida del inmueble', max_length=20)),
                ('inmValorInmueble', models.IntegerField(db_comment='Valor del inmueble', max_length=20)),
                ...
                ('inmEstado', models.CharField(choices=[('Disponible', 'Disponible'), ('Separado', 'Separado')], db_comment='estado de disponibilidad del Inmueble', max_length=20)),
                ...
                ('inmApartamento', models.ForeignKey(db_comment='hace refencia al tipo de inmueble', on_delete=django.db.models.deletion.PROTECT, to='appInmoSoft.apartamento')),
                ('inmCasa', models.ForeignKey(db_comment='hace referencia al tipo de inmueble', on_delete=django.db.models.deletion.PROTECT, to='appInmoSoft.casas')),
            ],
        ),
        migrations.CreateModel(
            name='PlanDePago',
            fields=[
                ...
                ('plaCuotaInicial', models.IntegerField(db_comment='Valor de la cuota Inicial', max_length=20)),
                ('plaValorDeCuota', models.IntegerField(db_comment='Valor de la Cuota', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ubiDepartamento', models.CharField(db_comment='ubicacion del departamento del proyecto', max_length=20)),
                ('ubiCuidad', models.CharField(db_comment='ubicacion de la cuidad del prouceto', max_length=20)),
                ('ubiDireccion', models.CharField(db_comment='Direccion del proyecto', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regValorPago', models.IntegerField(db_comment='Valor de pagode la cuota', max_length=20)),
                ('regPendiente', models.IntegerField(db_comment='Valor pendiente', max_length=20)),
                ('regRecaudo', models.IntegerField(db_comment='Recaudo total', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proFiducia', models.CharField(db_comment='Fiducia que va a contriduir en el proyecto', max_length=25)),
        ...
        migrations.AddField(
            model_name='inmueble',
            name='inmProyecto',
            field=models.ForeignKey(db_comment='prouecto que corresponde el inmueble', on_delete=django.db.models.deletion.PROTECT, to='appInmoSoft.proyecto'),
        ),
    ]

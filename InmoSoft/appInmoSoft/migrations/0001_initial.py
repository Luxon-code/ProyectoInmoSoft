# Generated by Django 4.2.2 on 2023-09-11 19:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Ya existe un usuario con ese correo electronico'}, max_length=150, unique=True, verbose_name='username')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('faNombre', models.CharField(db_comment='Nombre del familiar', max_length=20)),
                ('faApellido', models.CharField(db_comment='Apellido del familiar', max_length=20)),
                ('faTelefono', models.CharField(db_comment='Telefono del familiar', max_length=20)),
                ('faCorreo', models.CharField(db_comment='Correo del familiar', max_length=20)),
                ('faCedula', models.CharField(db_comment='cedula del familiar', max_length=20)),
                ('faDireccion', models.CharField(db_comment='Direccion del familiar', max_length=20)),

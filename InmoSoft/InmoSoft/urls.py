...
urlpatterns = [
    ...
    path('EnviarListaMora/<int:id>/',views.EnviarListaMora),
    ...
    path('numeroVentasPorAsesor/',views.numeroVentasPorAsesor),
    path('numeroVentasPorAsesor/<str:filtro_tiempo>/', views.numeroVentasPorAsesor, name='numeroVentasPorAsesorFiltrado'),

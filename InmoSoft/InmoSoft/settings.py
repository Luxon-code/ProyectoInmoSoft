"""
Django settings for InmoSoft project.
...
SECRET_KEY = 'django-insecure-(@=nwyj^=6gf87wp)#95o3yczm@m%$u8eobgtzibhw@v^eg2gj'
...
ROOT_URLCONF = 'InmoSoft.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['./appInmoSoft/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'InmoSoft.wsgi.application'
